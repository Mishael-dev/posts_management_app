	...
	return (
		<section>
			<h1 className="text-xl mb-8">
				This is my pratice project and in this project i will be learning:
				...
				its a post mannagement app where you can create, read, update and delete posts (CRUD) search by title,
